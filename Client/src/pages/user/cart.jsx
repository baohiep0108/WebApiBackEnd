                ...
                {cart.length === 0 ? (
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit}>
                            {cart.map((item) => (
                                <div
                                    ...
                                    <div className="col-span-12 lg:col-span-2 img box">
                                        <img src="https://pagedone.io/asset/uploads/1701162826.png" alt="product image"
                                    ...
                                    <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                                        ...
                                        <p className="font-normal text-base leading-7 text-gray-500 mb-6">
                                            {item.products.productDetails}
                                        </p>
                                        <div className="flex justify-between items-center">
                                            <div className="flex items-center gap-4">
                                                <button
                                                    onClick={() => updateCart(item.products.productId, item.quantity - 1)}
                                                    type="button"
                                                    ...
                                                    <svg
                                                        ...
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M4.5 9.5H13.5" stroke="" strokeWidth="1.6"
                                                              strokeLinecap="round"
                            ...
                            <div
                                className="flex flex-col md:flex-row items-center md:items-center justify-between lg:px-6 pb-6 border-b border-gray-200 max-lg:max-w-lg max-lg:mx-auto">
