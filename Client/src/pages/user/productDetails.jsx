...
function ProductDetails() {
    ...
    const handleSubmitComment = async (e) => {
        ...
        await dispatch(feedbackComment({ id, data }));
        await dispatch(fetchComment(id));
        setShowForm(false);
    };
            ...
            <div className="p-6 lg:max-w-7xl max-w-4xl mx-auto">
                <div
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex-wrap gap-4 mt-10">
                            <button type="button" onClick={AddToCart}
                                    className="min-w-[200px] px-4 py-2.5 border border-[#333] bg-transparent hover:bg-gray-200 text-[#333] text-sm font-semibold rounded ">Add
                                to cart
                            </button>
                            <div className="text-sm font-semibold rounded mt-6">
                                <h3 className="text-lg font-bold text-[#333]">Product information</h3>
                                <div className="my-5 mx-3 space-y-6 text-[#333]">
                                    <span className="text-sm">{product.productDetails}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
                    ...
                    {!showAllComments && feedback.length > 3 && (
                    ...
                    {feedback.length >= 0 && feedback.length <= 3 && (
                        <button type="button"
                                onClick={() => handleShowForm()}
                                className="w-full mt-10 px-4 py-2.5 bg-transparent hover:bg-gray-50 border border-[#333] text-[#333] font-bold rounded">
                            Feedback products
