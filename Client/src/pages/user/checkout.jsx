                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input type="text" id="email" name="email"
                                   ...
                                   placeholder="your.email@gmail.com" disabled={!payWithCard}/>
                            <div
                        ...
                        <div className="relative">
                            <input type="text" id="card-holder" name="card-holder"
                                   ...
                                   placeholder="Your full name here" disabled={!payWithCard}/>
                            <div
                                className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        ...
                        <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-medium">Address</label>
                        <div className="relative">
                            <input type="text" id="card-holder" name="card-holder"
                                   className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="Your full name here" disabled={!payWithCard}/>
