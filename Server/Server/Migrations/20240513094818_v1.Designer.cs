...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Helper.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApiShopCart.Model.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApi.Helper.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApi.Model.Order", b =>
                {
                    b.HasOne("WebApi.Helper.ApplicationUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
